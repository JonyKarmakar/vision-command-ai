...
export function VideoTrackingResultSection({
  ...
  return (
    <section className="card">
      <h2 ref={videoTrackingResultRef}>{isDeveloperMode ? 'Video Tracking Result' : 'Object tracking results'}</h2>
      ...
      {videoTrackingResult.tracks.length > 0 ? (
        <div className="track-summary-list">
          <h3>{isDeveloperMode ? 'Track Summary' : 'Tracked objects'}</h3>
      ...
      <div className="video-timeline">
        <h3>{isDeveloperMode ? 'Tracking Timeline' : 'Tracking timeline'}</h3>
