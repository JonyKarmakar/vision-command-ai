# VisionCommand AI API and Feature Reference

This document preserves the detailed feature inventory, API notes, endpoint examples, deployment notes, and technical reference material from the original README.

The main `README.md` is now intended to become a cleaner GitHub landing page, while this file keeps the deeper technical documentation available.
